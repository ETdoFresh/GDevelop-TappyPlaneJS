...
export class characterController extends behaviorScript {
    doStepPreEvents(delta) {
        this.behaviorData.NumberOfDirections = this.behaviorData.NumberOfDirections || 4;
        ...
        if (!this.topDownMovement) this.topDownMovement = this.object.getBehavior("TopDownMovement");
        if (!this.topDownMovement) return;

        const angle = this.topDownMovement.getAngle();
        if (this.behaviorData.NumberOfDirections === 4) {
        ...
        else if (this.behaviorData.NumberOfDirections === 8) {
        ...
        else if (this.behaviorData.NumberOfDirections === 16) {
